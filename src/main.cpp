...
void setup() {
  ...
  FastLED.addLeds<APA102, 21, 20, GBR, DATA_RATE_MHZ(DATA_RATE)>(leds, 144).setCorrection(TypicalSMD5050);
...
*/
enum Commands {Brightness = 0, Effect = 1, Info = 2};
/*
	...
	switch(currentEffect) {
		...
		*/
		case Colorwaves:
			...
			static CEveryNMilliseconds newPatterTime(40);
			if (newPatternTime) {
			...
			colorwave(leds, NUM_LEDS, gCurrentPalette, 341);
			break;
		/*
...
void colorwaves(CRGB* ledarray, uint16_t numleds, CRGBPalette16& palette)
{
	...
	//original beatsin88 values 25 and 40
	uint16_t brightnessthetainc16 = beatsin88(203, (75 * 256), (125 * 256));
	uint8_t msmultiplier = beatsin88(147, 23, 60);

	uint16_t hue16 = sHue16;//gHue * 256;
	//original beatsine88 113
